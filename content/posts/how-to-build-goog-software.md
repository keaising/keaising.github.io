...
总的来说，（构建好软件）的方法是用这些不同的反馈机制来有效地识别问题。小的反馈机制可以快速和简单地纠正小问题，但是在处理更大范围的问题时会略显乏力。大的反馈机制可以处理大范围问题但却缓慢而昂贵。你也许会想将二者紧密结合起来使用，尽可能多地处理问题，顺便还能有其他机制来搜集意料之外的错误。构建软件不是为了避免失败和犯错，而是战略性地快速试错，以尽快获取到足够你构建好软件所需的信息
